...
public class HeartBeatView extends AppCompatImageView {
    ...
    private static final float DEFAULT_SCALE_FACTOR = .2f;
    ...
    public void changeTint(int color) {
        DrawableCompat.setTint(getDrawable(), ContextCompat.getColor(getContext(), color));
    }

    private void init() {
        //make this not mandatory
        heartDrawable = ContextCompat.getDrawable(getContext(), R.drawable.heart);
